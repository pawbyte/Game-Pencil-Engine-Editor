...
GPE._obj_newObject1 =  (function (xPosIn, yPosIn,objectLayerId) 
{ 
    function _obj_newObject1 (xPosIn, yPosIn,objectLayerId) 
    { 
...
if( typeof objectLayerId!="number"){objectLayerId = 1;}
     ...
     {
         case 0:
             newObjOut = new GPE._obj_newObject1(newX, newY, objectLayerId);
         break;
         default:
         break;
     }
